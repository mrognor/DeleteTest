...
\DoxyCodeLine{91 }
\DoxyCodeLine{99         \textcolor{keyword}{virtual} \textcolor{keywordtype}{void} \mbox{\hyperlink{class_e_n_1_1_e_n___u_d_p___server_a6343c34978da206a30c69ed54ebc048d}{ClientMessageHandler}}(std::string message, std::string ClientSocketAddr, \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} TimeWhenPackageArrived) = 0;}
\DoxyCodeLine{100 }
\DoxyCodeLine{109         \textcolor{keyword}{virtual} \textcolor{keywordtype}{bool} \mbox{\hyperlink{class_e_n_1_1_e_n___u_d_p___server_a26235d96390965c8bd88f46ac83c89fa}{InstantClientMessageHandler}}(std::string message, std::string ClientSocketAddr, \textcolor{keywordtype}{long} \textcolor{keywordtype}{long} TimeWhenPackageArrived) = 0;}
\DoxyCodeLine{110 }
...
\DoxyCodeLine{127 }
\DoxyCodeLine{134         \textcolor{keywordtype}{void} \mbox{\hyperlink{class_e_n_1_1_e_n___u_d_p___server_a741f40c45c15ea3600313307e696ecfd}{SendToClient}}(std::string message, std::string ClientSocketAddr);}
\DoxyCodeLine{135 }
